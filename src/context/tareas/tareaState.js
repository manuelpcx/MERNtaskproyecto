...
const TareaState = props => {
    ...
    const initialState = {
        tareas: [
            ...
            {id: 2, nombre: 'Elegir Framework', estado: true, proyectoId: 3},
            ...
            {id: 7, nombre: 'Elegir Framework', estado: true, proyectoId: 4},
            ...
            {id: 11, nombre: 'Elegir Framework', estado: true, proyectoId: 2},
            {id: 12, nombre: 'Elegir Hosting', estado: false, proyectoId: 1},
            {id: 13, nombre: 'Elegir Plataforma', estado: true, proyectoId: 1},
            {id: 14, nombre: 'Elegir Colores', estado: false, proyectoId: 2},
            {id: 15, nombre: 'Elegir Framework', estado: true, proyectoId: 3},
